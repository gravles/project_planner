          ...
          {sorted.map(project => {
            ...
            return (
              <tr
                ...
                className="border-b border-border/40 cursor-pointer hover:bg-bg-elevated transition-colors group"
              >
                ...
                <td className="px-4 py-3 text-xs text-text-muted whitespace-nowrap">{project.room}</td>
                ...
                <td className="px-4 py-3 text-xs text-text-muted">{project.vendor || '—'}</td>
              </tr>
            )
          })}
          {sorted.length === 0 && (
